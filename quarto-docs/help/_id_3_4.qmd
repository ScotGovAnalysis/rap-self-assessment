...
A further step in ensuring reproducibility of a RAP is to document the programming language version (e.g. R 4.2.2) and operating system (e.g. Windows 10 x64 (build 19045)) on which the code was developed and can be ran successfully.
