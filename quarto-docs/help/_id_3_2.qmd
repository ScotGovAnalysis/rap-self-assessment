...
Unit tests verify individual units of code are working correctly. In R and Python, tests may be coded to ensure individual functions are returning the expected outputs.
