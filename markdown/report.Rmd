...
source(here::here("modules", "level_label.R"))
```
...
```{r, echo = FALSE, dev = "svg", fig.align = "center", fig.width = mm_to_inch(220), fig.height = mm_to_inch(130)}
chart_data <- 
  level_summary |>
...
level_summary |>
  ...
  mutate(level = level_label(level, params$all_levels)) |>
  gt() |>
  tab_spanner(
